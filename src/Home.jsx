...
<Navbar/>
      ...
      <aside className=" w-full h-2/4  flex flex-col items-center relative  md:w-1/4  h-full  justify-center items-center ">





<div className="squere-rotate   w-full h-full   md:h-2/4   
"></div>



<div className="squere-stick h-full md:h-3/5 absolute top-30 right-20 bg-blue-500/50	 w-8"></div>
        ...
        <article className="w-10/12 h-2/4 pt-10  flex flex-col items-center justify-center gap-4  md:w-1/4 h-full  justify-center   ">
